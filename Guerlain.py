...
MARQUE_CIBLE = "Guerlain (Simulé)"
PLATEFORME = "E-commerce"
SITE_SOURCE = "Books to Scrape"
CATEGORIE = "Parfumerie de Luxe"
...
with open("guerlain_books_complet.csv", "w", newline="", encoding="utf-8") as fichier:
...
driver.quit()
print(f"✅ Terminé ! Le fichier 'guerlain_books_complet.csv' est prêt.")