...
# --- CONFIGURATION ---
MARQUE_CIBLE = "Nivea (Simulé)"
PLATEFORME = "E-commerce"
SITE_SOURCE = "Books to Scrape"
CATEGORIE = "Soin du corps & Hygiène"
...
with open("nivea_books_complet.csv", "w", newline="", encoding="utf-8") as fichier:
...
driver.quit()
print(f" Terminé ! Le fichier 'nivea_books_complet.csv' est prêt.")