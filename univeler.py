...
with open("unilever_books_complet.csv", "w", newline="", encoding="utf-8") as fichier:
...
driver.quit()
print(f"Terminé : unilever_books_complet.csv est prêt.")